package
{
	...
	public class JoustCardBase extends MovieClip
	{
		...
		private var importedClasses:Array = [MC_wagon, MC_vacuum, MC_unicycle, MC_tricycle, 
			...
			MC_lavalamp_card, MC_laserpointer_card, MC_horse_card, MC_hippo_card, MC_hampsterBall_card, 
			MC_hampster_card, MC_ham_card, MC_gyrocopter_card, MC_gorilla_card, MC_golfclub_card, MC_drone_card, 
			...
			MC_bananas_card, MC_baby_card, MC_pug_weapon_card, MC_pogostick_weapon_card, MC_cactus_weapon
		];
